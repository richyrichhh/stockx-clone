...
product4 = Product.create!(name: 'Royal', model: "Air Jordan 1", brand: "Jordan", description: 'The OG', style_code: '4282', colorway: 'black royal-blue', retail_price: '65', release_date: '15/9/1985', img_path: 'https://stockx.imgix.net/Air-Jordan-1-OG-Royal-1985.png')
...
product6 = Product.create!(name: 'Concord', model: "Air Jordan 11", brand: "Jordan", description: 'what u know', style_code: '136046-171', colorway: 'white black dark-concord', retail_price: 165, img_path: 'https://stockx-360.imgix.net/air-jordan-11-retro-concord-2011_TruView/Images/air-jordan-11-retro-concord-2011_TruView/Lv2/img01.jpg', release_date: '23/12/2011')
product7 = Product.create!(name: 'Tiffany', model: 'Nike SB Dunk Low', brand: 'Nike', description: 'you already know', style_code: '304292-402', colorway: 'aqua chrome', retail_price: 89, img_path: 'https://stockx.imgix.net/Nike-Dunk-SB-Low-Diamond-Supply-Co-Tiffany-Product.jpg', release_date: '01/08/2005')
