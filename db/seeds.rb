...
order18 = Order.create!(product_id: product2.id, asker_id: user1.id, price: 500, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order19 = Order.create!(product_id: product3.id, asker_id: user1.id, price: 500, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order20 = Order.create!(product_id: product4.id, asker_id: user1.id, price: 500, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order21 = Order.create!(product_id: product5.id, asker_id: user1.id, price: 500, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order22 = Order.create!(product_id: product6.id, asker_id: user1.id, price: 500, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order23 = Order.create!(product_id: product7.id, asker_id: user1.id, price: 500, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order24 = Order.create!(product_id: product8.id, asker_id: user1.id, price: 500, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order25 = Order.create!(product_id: product9.id, asker_id: user1.id, price: 500, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order26 = Order.create!(product_id: product10.id, asker_id: user1.id, price: 500, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order27 = Order.create!(product_id: product11.id, asker_id: user1.id, price: 500, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
...
order29 = Order.create!(product_id: product13.id, asker_id: user1.id, price: 500, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order30 = Order.create!(product_id: product14.id, asker_id: user1.id, price: 500, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order31 = Order.create!(product_id: product15.id, asker_id: user1.id, price: 500, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order32 = Order.create!(product_id: product16.id, asker_id: user1.id, price: 500, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order33 = Order.create!(product_id: product1.id, asker_id: user1.id, price: 1000, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order34 = Order.create!(product_id: product2.id, asker_id: user1.id, price: 1000, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order35 = Order.create!(product_id: product3.id, asker_id: user1.id, price: 1000, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order36 = Order.create!(product_id: product4.id, asker_id: user1.id, price: 1000, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order37 = Order.create!(product_id: product5.id, asker_id: user1.id, price: 1000, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order38 = Order.create!(product_id: product6.id, asker_id: user1.id, price: 1000, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order39 = Order.create!(product_id: product7.id, asker_id: user1.id, price: 1000, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order40 = Order.create!(product_id: product8.id, asker_id: user1.id, price: 1000, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order41 = Order.create!(product_id: product9.id, asker_id: user1.id, price: 1000, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order42 = Order.create!(product_id: product10.id, asker_id: user1.id, price: 1000, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order43 = Order.create!(product_id: product11.id, asker_id: user1.id, price: 1000, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
...
order45 = Order.create!(product_id: product13.id, asker_id: user1.id, price: 1000, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
