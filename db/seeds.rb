...
user1 = User.create(username: 'admin', password: 'abc123', email: 'admin@site.com')
...
product2 = Product.create(name: 'Air Jordan 3 \"White Cement\"', description: 'Also a classic', style_code: "136064 105", colorway: 'white fire red cement grey black', retail_price: 200, img_path: 'https://www.flightclub.com/media/catalog/product/cache/1/image/1600x1140/9df78eab33525d08d6e5fb8d27136e95/6/3/63611742962-air-jordan-1-retro-high-og-bred-black-varsity-red-white-011845_1.jpg', release_date: '3/9/2016')

PortfolioItem.create(user_id: user1.id, product_id: product1.id, size: 'M 9')
PortfolioItem.create(user_id: user1.id, product_id: product2.id, size: 'M 9')
