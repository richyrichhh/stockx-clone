...
product7 = Product.create!(name: 'Tiffany', model: 'Nike SB Dunk Low', brand: 'Nike', description: 'Iconic', style_code: '304292-402', colorway: 'aqua chrome', retail_price: 89, img_path: 'https://stockx.imgix.net/Nike-Dunk-SB-Low-Diamond-Supply-Co-Tiffany-Product.jpg', release_date: '01/08/2005')
...
product9 = Product.create!(name: 'Blink', model: 'Air Yeezy', brand: 'Nike', description: 'Part of Kanye\'s first yeezy collection', style_code: '366164-003', colorway: 'black black', retail_price: 250, img_path: 'https://stockx-360.imgix.net/Nike-Air-Yeezy-1-Black-Pink-Blink_TruView/Images/Nike-Air-Yeezy-1-Black-Pink-Blink_TruView/Lv2/img01.jpg', release_date: '04/04/2009')
product10 = Product.create!(name: 'Turtledove', model: 'Yeezy Boost 350', brand: 'adidas', description: 'First adidas shoe added here', style_code: 'AQ4832', colorway: 'turtledove blue grey-white', retail_price: 200, img_path: 'https://stockx-360.imgix.net/Adidas-Yeezy-Boost-350-Low-Turtledove/Images/Adidas-Yeezy-Boost-350-Low-Turtledove/Lv2/img01.jpg', release_date: '06/27/2015')
