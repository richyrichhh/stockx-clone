...
order17 = Order.create!(product_id: product1.id, asker_id: user1.id, price: 500, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order18 = Order.create!(product_id: product2.id, asker_id: user1.id, price: 50, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order19 = Order.create!(product_id: product3.id, asker_id: user1.id, price: 5, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order20 = Order.create!(product_id: product4.id, asker_id: user1.id, price: 123, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order21 = Order.create!(product_id: product5.id, asker_id: user1.id, price: 456, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order22 = Order.create!(product_id: product6.id, asker_id: user1.id, price: 789, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order23 = Order.create!(product_id: product7.id, asker_id: user1.id, price: 400, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order24 = Order.create!(product_id: product8.id, asker_id: user1.id, price: 850, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order25 = Order.create!(product_id: product9.id, asker_id: user1.id, price: 2500, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order26 = Order.create!(product_id: product10.id, asker_id: user1.id, price: 1000, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order27 = Order.create!(product_id: product11.id, asker_id: user1.id, price: 1200, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order28 = Order.create!(product_id: product12.id, asker_id: user1.id, price: 500, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order29 = Order.create!(product_id: product13.id, asker_id: user1.id, price: 400, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order30 = Order.create!(product_id: product14.id, asker_id: user1.id, price: 400, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order31 = Order.create!(product_id: product15.id, asker_id: user1.id, price: 20000, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order32 = Order.create!(product_id: product16.id, asker_id: user1.id, price: 88, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order33 = Order.create!(product_id: product1.id, asker_id: user1.id, price: 600, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order34 = Order.create!(product_id: product2.id, asker_id: user1.id, price: 60, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order35 = Order.create!(product_id: product3.id, asker_id: user1.id, price: 6, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order36 = Order.create!(product_id: product4.id, asker_id: user1.id, price: 147, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order37 = Order.create!(product_id: product5.id, asker_id: user1.id, price: 479, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order38 = Order.create!(product_id: product6.id, asker_id: user1.id, price: 888, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order39 = Order.create!(product_id: product7.id, asker_id: user1.id, price: 444, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order40 = Order.create!(product_id: product8.id, asker_id: user1.id, price: 920, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order41 = Order.create!(product_id: product9.id, asker_id: user1.id, price: 3000, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order42 = Order.create!(product_id: product10.id, asker_id: user1.id, price: 1300, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order43 = Order.create!(product_id: product11.id, asker_id: user1.id, price: 1500, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order44 = Order.create!(product_id: product12.id, asker_id: user1.id, price: 1000, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order45 = Order.create!(product_id: product13.id, asker_id: user1.id, price: 600, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order46 = Order.create!(product_id: product14.id, asker_id: user1.id, price: 600, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order47 = Order.create!(product_id: product15.id, asker_id: user1.id, price: 30000, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order48 = Order.create!(product_id: product16.id, asker_id: user1.id, price: 100, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order49 = Order.create!(product_id: product1.id, asker_id: user1.id, price: 369, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
