...
order2 = Order.create!(product_id: product2.id, asker_id: user1.id, price: 100, order_type: 'buy', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order3 = Order.create!(product_id: product3.id, asker_id: user1.id, price: 135, order_type: 'buy', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
...
order17 = Order.create!(product_id: product1.id, asker_id: user1.id, price: 500 + rand(50) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order18 = Order.create!(product_id: product2.id, asker_id: user1.id, price: 100 + rand(10) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order19 = Order.create!(product_id: product3.id, asker_id: user1.id, price: 135 + rand(10) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order20 = Order.create!(product_id: product4.id, asker_id: user1.id, price: 123 + rand(10) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order21 = Order.create!(product_id: product5.id, asker_id: user1.id, price: 456 + rand(45) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order22 = Order.create!(product_id: product6.id, asker_id: user1.id, price: 789 + rand(80) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order23 = Order.create!(product_id: product7.id, asker_id: user1.id, price: 400 + rand(40) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order24 = Order.create!(product_id: product8.id, asker_id: user1.id, price: 850 + rand(85) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order25 = Order.create!(product_id: product9.id, asker_id: user1.id, price: 2500 + rand(250) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order26 = Order.create!(product_id: product10.id, asker_id: user1.id, price: 1000 + rand(180) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order27 = Order.create!(product_id: product11.id, asker_id: user1.id, price: 1200 + rand(120) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order28 = Order.create!(product_id: product12.id, asker_id: user1.id, price: 500 + rand(50) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order29 = Order.create!(product_id: product13.id, asker_id: user1.id, price: 400 + rand(40) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order30 = Order.create!(product_id: product14.id, asker_id: user1.id, price: 400 + rand(40) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order31 = Order.create!(product_id: product15.id, asker_id: user1.id, price: 20000 + rand(200) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order32 = Order.create!(product_id: product16.id, asker_id: user1.id, price: 88 + rand(10) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order33 = Order.create!(product_id: product1.id, asker_id: user1.id, price: 600 + rand(60) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order34 = Order.create!(product_id: product2.id, asker_id: user1.id, price: 120 + rand(10) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order35 = Order.create!(product_id: product3.id, asker_id: user1.id, price: 140 + rand(10) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order36 = Order.create!(product_id: product4.id, asker_id: user1.id, price: 147 + rand(15) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order37 = Order.create!(product_id: product5.id, asker_id: user1.id, price: 479 + rand(48) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order38 = Order.create!(product_id: product6.id, asker_id: user1.id, price: 888 + rand(89) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order39 = Order.create!(product_id: product7.id, asker_id: user1.id, price: 444 + rand(44) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order40 = Order.create!(product_id: product8.id, asker_id: user1.id, price: 920 + rand(92) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order41 = Order.create!(product_id: product9.id, asker_id: user1.id, price: 3000 + rand(300) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order42 = Order.create!(product_id: product10.id, asker_id: user1.id, price: 1300 + rand(130) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order43 = Order.create!(product_id: product11.id, asker_id: user1.id, price: 1500 + rand(150) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order44 = Order.create!(product_id: product12.id, asker_id: user1.id, price: 1000 + rand(100) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order45 = Order.create!(product_id: product13.id, asker_id: user1.id, price: 600 + rand(60) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order46 = Order.create!(product_id: product14.id, asker_id: user1.id, price: 600 + rand(60) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order47 = Order.create!(product_id: product15.id, asker_id: user1.id, price: 30000 + rand(3000) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order48 = Order.create!(product_id: product16.id, asker_id: user1.id, price: 100 + rand(10) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
order49 = Order.create!(product_id: product1.id, asker_id: user1.id, price: 369 + rand(10) + 1, order_type: 'sell', active: 'true', sold: 'false', shipped: 'false', sex: 'M', size: '9')
...
sale1b = Sale.create!(product_id: order1.product_id, order_id: order1.id, sex: order1.sex, size: order1.size, date: Date.today.to_s.split('-').join('/'), active: 'true', price: order1.price + rand(11) - 5)
...
sale2b = Sale.create!(order_id: order2.id, product_id: order2.product_id, sex: order2.sex, size: order2.size, date: Date.today.to_s.split('-').join('/'), active: 'true', price: order2.price + rand(11) - 5)
...
sale3b = Sale.create!(order_id: order3.id, product_id: order3.product_id, sex: order3.sex, size: order3.size, date: Date.today.to_s.split('-').join('/'), active: 'true', price: order3.price + rand(11) - 5)
sale4 = Sale.create!(order_id: order3.id, product_id: order3.product_id, sex: order3.sex, size: order3.size, date: Date.yesterday.to_s.split('-').join('/'), active: 'true', price: order3.price + rand(11) - 5)
sale4b = Sale.create!(order_id: order3.id, product_id: order3.product_id, sex: order3.sex, size: order3.size, date: Date.yesterday.to_s.split('-').join('/'), active: 'true', price: order3.price + rand(11) - 5)
...
sale5b = Sale.create!(order_id: order4.id, product_id: order4.product_id, sex: order4.sex, size: order4.size, date: Date.today.to_s.split('-').join('/'), active: 'true', price: order4.price + rand(11) - 5)
...
sale6b = Sale.create!(order_id: order5.id, product_id: order5.product_id, sex: order5.sex, size: order5.size, date: Date.today.to_s.split('-').join('/'), active: 'true', price: order5.price + rand(11) - 5)
...
sale7b = Sale.create!(order_id: order6.id, product_id: order6.product_id, sex: order6.sex, size: order6.size, date: Date.today.to_s.split('-').join('/'), active: 'true', price: order6.price + rand(11) - 5)
...
sale8b = Sale.create!(order_id: order7.id, product_id: order7.product_id, sex: order7.sex, size: order7.size, date: Date.today.to_s.split('-').join('/'), active: 'true', price: order7.price + rand(11) - 5)
...
sale9b = Sale.create!(order_id: order8.id, product_id: order8.product_id, sex: order8.sex, size: order8.size, date: Date.today.to_s.split('-').join('/'), active: 'true', price: order8.price + rand(11) - 5)
...
sale10b = Sale.create!(order_id: order9.id, product_id: order9.product_id, sex: order9.sex, size: order9.size, date: Date.today.to_s.split('-').join('/'), active: 'true', price: order9.price + rand(11) - 5)
...
sale11b = Sale.create!(order_id: order10.id, product_id: order10.product_id, sex: order10.sex, size: order10.size, date: Date.today.to_s.split('-').join('/'), active: 'true', price: order10.price + rand(11) - 5)
...
sale12b = Sale.create!(order_id: order11.id, product_id: order11.product_id, sex: order11.sex, size: order11.size, date: Date.today.to_s.split('-').join('/'), active: 'true', price: order11.price + rand(11) - 5)
...
sale13b = Sale.create!(order_id: order12.id, product_id: order12.product_id, sex: order12.sex, size: order12.size, date: Date.today.to_s.split('-').join('/'), active: 'true', price: order12.price + rand(11) - 5)
...
sale14b = Sale.create!(order_id: order13.id, product_id: order13.product_id, sex: order13.sex, size: order13.size, date: Date.today.to_s.split('-').join('/'), active: 'true', price: order13.price + rand(11) - 5)
...
sale15b = Sale.create!(order_id: order14.id, product_id: order14.product_id, sex: order14.sex, size: order14.size, date: Date.today.to_s.split('-').join('/'), active: 'true', price: order14.price + rand(11) - 5)
...
sale16b = Sale.create!(order_id: order15.id, product_id: order15.product_id, sex: order15.sex, size: order15.size, date: Date.today.to_s.split('-').join('/'), active: 'true', price: order15.price + rand(11) - 5)
...
sale17b = Sale.create!(order_id: order16.id, product_id: order16.product_id, sex: order16.sex, size: order16.size, date: Date.today.to_s.split('-').join('/'), active: 'true', price: order16.price + rand(11) - 5)
