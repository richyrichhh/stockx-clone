...
ActiveRecord::Schema.define(version: 2020_03_27_200501) do
  ...
  create_table "follows", force: :cascade do |t|
    ...
    t.index ["product_id"], name: "index_follows_on_product_id"
    t.index ["user_id", "product_id"], name: "index_follows_on_user_id_and_product_id", unique: true
